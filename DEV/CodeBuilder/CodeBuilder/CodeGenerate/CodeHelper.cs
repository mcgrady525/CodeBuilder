...
namespace CodeBuilder
{
    ...
    public static class CodeHelper
    {
        ...
        /// 数据库列类型至对象类型映射
        /// </summary>
        public static string GetCodeTypeName(string columnTypeName)
        {
            columnTypeName = columnTypeName.ToLower();
            ...
            else if (columnTypeName == "money")
            {
                return "decimal";
            }
            else if (columnTypeName == "bit")
            {
                return "bool";
            }
            ...
            else if (columnTypeName == "uniqueidentifier")
            {
                return "Guid";
            }
